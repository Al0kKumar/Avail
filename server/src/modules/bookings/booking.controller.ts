...
export const createBooking = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    try {
      await sendEmail({
        to: guestEmail,
        subject: '[Guest Copy] Your booking is confirmed',
      ...
      await sendEmail({
        to: host.email || '',
        subject: '[Host Copy] New booking received',
  ...
  async (req: AuthRequest, res: Response) => {
    ...
    try {
      await sendEmail({
        ...
        subject: '[Guest Copy] Your booking has been cancelled',
      ...
      await sendEmail({
      to: host.email || '',
      subject: '[Host Copy] Booking cancelled',
